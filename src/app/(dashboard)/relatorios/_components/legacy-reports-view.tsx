...
import { SpreadsheetSection } from "./spreadsheet-section";
import { InternalReportDocuments } from "./internal-report-documents";
import { ReportTrendCharts } from "./report-trend-charts";
        ...
        <section aria-labelledby="report-shortcuts-title">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
            {reportCards.map((report) => {
              ...
              return (
                <Card key={report.title} variant="compact" className="p-0 group">
                  <Link
                    href={report.href}
