    ...
    <>
      <section aria-labelledby="overview-kpi-title">
        <div className="mb-3 flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <h2 id="overview-kpi-title" className="font-medium text-foreground">
            Resumo do período
          </h2>
        ...
        <DashboardGrid className="grid-cols-2 sm:grid-cols-3 xl:grid-cols-5">
          ...
          {commercial.revenue !== null && (
            <KpiComparisonCard
              label="Receita ativa"
              value={commercial.revenue.toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
          ...
          {commercial.avgTicket !== null && (
            <KpiComparisonCard
              label="Ticket médio"
              value={commercial.avgTicket.toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
