...
describe("Meta Lead Ads normalization", () => {
  it("maps Meta standard fields without retaining unrelated form answers", () => {
    expect(normalizeMetaLead({
      id: "leadgen_123", ad_id: "ad_1", form_id: "form_1",
      field_data: [
    ...
    })).toEqual({ nome: "Ana Lima", telefone: "+55 21 99999-0000", email: "ana@example.test", externalId: "leadgen_123", adId: "ad_1", formId: "form_1" });
  });
