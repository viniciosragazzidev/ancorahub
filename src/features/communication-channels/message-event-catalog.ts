...
export const MESSAGE_EVENT_CATALOG = [
  ...
  },
  {
    ...
    description: "Envia o template new_lead_broker e o link para aceitar um lead da fila.",
    audience: "user",
    windowRule: "corporate_internal",
    variables: [
      { key: "cargo", label: "Cargo do corretor", aliases: ["broker_role"], fallback: "Corretor(a)" },
      brokerName,
      leadName,
      { key: "produto_interesse", label: "Produto de interesse", aliases: ["interesse", "product_interest", "tipo_lead", "lead_type"], fallback: "Plano de saúde" },
      leadId,
    ],
  },
  {
