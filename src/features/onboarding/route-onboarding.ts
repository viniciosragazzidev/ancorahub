...
export const routeOnboardingDefinitions: readonly RouteOnboardingDefinition[] = [
  ...
  route("reports", ["/dashboard"], "Decisões com contexto", "Compare operação, conversão e produtividade sem perder o responsável por trás dos números.", "reports", "Aplique filtros de período e unidade para transformar o panorama em decisão."),
  ...
  route("settings", ["/settings", "/integrations/whatsapp", "/assinatura"], "Seu espaço, do seu jeito", "Ajuste preferências pessoais e integrações disponíveis sem sair do ambiente da plataforma.", "settings", "Configurações da corretora e configurações pessoais aparecem separadas por permissão."),
