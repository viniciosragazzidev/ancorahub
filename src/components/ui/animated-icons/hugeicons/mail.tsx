...
export interface HugeiconsMailIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface HugeiconsMailIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
HugeiconsMailIcon.displayName = 'HugeiconsMailIcon';

export { HugeiconsMailIcon };
