...
export function mountPanel(onOpenLead: (leadId: string) => void): MountedPanel | null {
  ...
  </style><section class="panel"><header class="top"><span class="mark" aria-hidden="true">A</span><div class="title expanded"><strong>AncoraHub Assistant</strong><span>Lead autorizado</span></div><button class="icon expanded" type="button" data-action="collapse" aria-label="Recolher painel"><span class="collapse-arrow">›</span></button><button class="icon collapsed-only" type="button" data-action="expand" aria-label="Expandir AncoraHub Assistant"><span class="collapse-arrow">‹</span></button></header><div id="content" class="content expanded"></div></section>`;
