...
export async function sendTestMessage(config, input) {
    if (!config.reviewEnabled)
        throw new Error("O envio de revisão está desativado.");
    ...
    if (!messageId)
        throw new Error("A Meta não retornou o identificador da mensagem.");
    return { messageId };
}
