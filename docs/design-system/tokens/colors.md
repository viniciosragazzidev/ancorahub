...
| `color.surface.subtle` | `#f7fafc` | snow de referência | superfícies discretas, após DG-001 | assumir `#fafafa`. |
...
Iris, Magenta, Leaf, Coral, Ice, Lavender e Blush são **CONFIRMED como cores decorativas**, mas não possuem token semântico de produção. Status é **MISSING** (DG-002). Carbon `#0f0f0f` tem papel conflitante (DG-001).
