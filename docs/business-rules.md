...
| BR-029R | A importação CSV preserva a fila automática selecionada e nunca atribui diretamente por uma regra paralela. | Importação válida → servidor revalida tenant, unidade, estado e modo da fila; lead é persistido sem owner e com job idempotente. O motor oferece pelo WhatsApp oficial a um elegível por vez, respeita aceite atômico e percorre os elegíveis até aceite ou esgotamento. | DEC-096 |
