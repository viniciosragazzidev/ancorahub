...
| BR-062D | Cargo, unidade, desativação e exclusão de membro têm efeito autoritativo no servidor. Diretor pode editar o cargo ou perfil de outro Diretor somente quando ambos pertencem à mesma unidade explícita; isso não concede poder de excluir, desativar, autoeditar ou mover o alvo para outra unidade. | Alteração de autoridade → servidor revalida tenant, ator, alvo e unidade, atualiza o vínculo, registra auditoria e revoga sessões; exclusão → remove apenas o vínculo do tenant e revoga sessões; vínculos inativos não participam da resolução do contexto. | DEC-095 |
