...
| BR-029S | Nenhum lead operacional elegível permanece sem corretor enquanto houver capacidade disponível na fila. | Entrada sem unidade → unidade automática de menor carga; fila inativa → reparo auditado; escolha respeita disponibilidade, canal, plantão, política e ranking; capacidade da fila cheia → permanece em `queued` sem exceder o limite e é reavaliada pelo worker. Uma remoção explícita de atribuição cria `manual_hold` e só uma nova ação manual pode retomá-la. | DEC-097, DEC-104, DEC-109, DEC-113 |
