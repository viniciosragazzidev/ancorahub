...
| BR-029S | Nenhum lead operacional pode permanecer sem corretor enquanto houver corretor elegível em sua unidade. | Entrada sem unidade → unidade automática de menor carga; unidade operacional definida com auto desligado → reativação auditada; fila inativa → reparo para política global; seleção → disponibilidade, canal, plantão, política, menor fila sem contato e menor carga; fora do plantão, a fila segue sua política declarada (unidade, aguardar ou contingência); capacidade cheia → continua pelo ranking. A oferta cria owner provisório visível; recusa, expiração ou SLA → troca atômica para o próximo elegível, sem estado intermediário órfão. | DEC-097, DEC-104, DEC-109 |
