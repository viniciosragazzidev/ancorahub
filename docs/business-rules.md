...
| BR-029M | Distribuição automática e aviso de novo lead respeitam a janela comercial. | De segunda a sexta, das 08:00 até antes de 18:00 (America/Sao_Paulo) → o job distribui e o template `new_lead_broker` pode ser enviado; fora dela → lead e outbox permanecem persistidos para a próxima abertura. Atribuição manual permanece disponível; aviso pendente é cancelado se o lead mudar de corretor antes do envio. | DEC-083 |
...
| BR-029Q | Um lead pode ter no máximo uma oferta ativa por vez e nenhum corretor vira owner antes do aceite. | Oferta criada → a linha do lead é serializada e qualquer oferta ativa concorrente bloqueia nova criação; recusa, expiração, canal indisponível ou falha de enqueue marca a tentativa e avança ao próximo elegível ainda não tentado. Todos tentados sem aceite → inicia outro ciclo automático preservando o histórico; sem elegível → permanece em retry auditável. | DEC-049 |
