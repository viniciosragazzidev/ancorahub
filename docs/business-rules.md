...
| BR-062C | A importação CSV de corretores nunca ativa contas diretamente e nunca exige e-mail antecipado. | Linha com nome e telefone válidos → cria perfil e convite pendentes → enfileira `broker_first_access` no WhatsApp oficial; sem e-mail → convidado define e-mail novo e senha no primeiro acesso; identidade já existente é rejeitada e somente o aceite ativa o perfil. | DEC-094 |
