...
| BR-029K | Estouro de prazo da qualificação preserva a fila do tipo/campanha configurado no intake. | Após o timeout → o lead entra ou permanece na fila ativa configurada; o job tenta somente corretores da unidade desta fila. Sem elegível, o lead continua em fila com retry auditável. | DEC-080 |
