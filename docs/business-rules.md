...
| BR-023 | Novo lead elegível entra em um ciclo sequencial de ofertas entre corretores elegíveis da fila/unidade. | Lead recebido → um único corretor recebe a oferta; `corretorId` só é gravado após aceite atômico. Recusa/expiração avança ao próximo ainda não tentado. | RF020–021, RF102, DEC-049 |
