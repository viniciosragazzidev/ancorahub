...
| BR-028 | Estouro de SLA remove o corretor responsável antes de redistribuir e consome sua tentativa no ciclo atual. | SLA estourou → remove owner, volta para `queued` e retoma o mesmo ciclo sequencial pelo próximo elegível; intervenção manual ocorre somente após esgotamento do ciclo ou ausência de caminho automático utilizável. | DEC-027A, DEC-049 |
