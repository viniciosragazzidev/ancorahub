...
| BR-023 | Novo lead elegível entra em um ciclo sequencial de ofertas entre corretores elegíveis da fila/unidade. | Lead recebido → um único corretor recebe a oferta e se torna titularidade **provisória**; o aceite confirma a titularidade. Recusa/expiração avança atomicamente ao próximo ainda não tentado, sem deixar o lead sem owner quando houver elegível. | RF020–021, RF102, DEC-049, DEC-097 |
...
| BR-029M | Distribuição automática garante titularidade 24/7; a janela comercial regula somente a entrega de mensagens. | Lead elegível entra → o motor central resolve unidade/fila e cria oferta; o corretor escolhido vira owner provisório imediatamente. Sem elegível ou em pausa explícita → mantém o owner anterior e a task reavalia. | DEC-083 (emendada por DEC-097) |
