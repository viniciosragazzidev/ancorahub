...
This directory contains precise design-engineering implementation plans to improve the feel, performance, and cohesion of motion throughout the CorreTop workspace, following the guidelines in [MACRO-MICRO_ANIMATIONS.md](../motion/MACRO-MICRO_ANIMATIONS.md).
